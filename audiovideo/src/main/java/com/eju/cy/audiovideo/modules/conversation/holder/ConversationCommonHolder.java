...
public class ConversationCommonHolder extends ConversationBaseHolder {
    ...
    public ConversationCommonHolder(View itemView) {
        ...
        id_flowlayout = rootView.findViewById(R.id.id_flowlayout);
    ...
    public void layoutViews(ConversationInfo conversation, int position) {
         ...
         * 设置标签
         */
        if (null != conversation.getUserRoleList() && conversation.getUserRoleList().size() > 0) {

            TagAdapter<String> tagAdapter = new TagAdapter<String>(conversation.getUserRoleList()) {
                ...
                public View getView(FlowLayout parent, int position, String s) {
                    ...
                    BLTextView tv = (BLTextView) inflater.inflate(R.layout.tag_tv_layout,
                            parent, false);
                    tv.setText(s);
      ...
      //  LogUtils.w("getUserLevel----"+conversation.getUserLevel());
        //设置角标
