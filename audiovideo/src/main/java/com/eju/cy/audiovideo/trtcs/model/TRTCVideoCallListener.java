...
public interface TRTCVideoCallListener {
     ...
     * @param jurisdictionList 有权限开视频的人
     */
    void onInvited(String sponsor, List<String> userIdList, List<String> jurisdictionList, boolean isFromGroup, String groupId, int callType);
     ...
     */
    void onGroupCallInviteeListUpdate(List<String> userIdList, List<String> jurisdictionList);
