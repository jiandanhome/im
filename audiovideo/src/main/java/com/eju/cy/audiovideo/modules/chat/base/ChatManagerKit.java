    ...
    public void revokeMessage(final int position, final MessageInfo messageInfo) {
        ...
        mCurrentConversation.revokeMessage(messageInfo.getTIMMessage(), new TIMCallBack() {
            ...
            public void onSuccess() {
                ...
                ConversationManagerKit.getInstance().loadC2CConversation(null);
                ConversationManagerKit.getInstance().loadC2cAndFriendsConversation(null);
                ConversationManagerKit.getInstance().loadC2cAndNonFriendsConversation(null);
            }
        });
    }
