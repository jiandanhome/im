package com.eju.cy.audiovideo.modules.chat.layout.message;
...
import com.eju.cy.audiovideo.modules.chat.layout.message.holder.MessageBaseHolder;
import com.eju.cy.audiovideo.modules.chat.layout.message.holder.MessageContentHolder;
import com.eju.cy.audiovideo.modules.chat.layout.message.holder.MessageCustomHolder;
import com.eju.cy.audiovideo.modules.chat.layout.message.holder.MessageEmptyHolder;
import com.eju.cy.audiovideo.modules.chat.layout.message.holder.MessageHeaderHolder;
...
public class MessageListAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (getItemViewType(position) == MessageInfo.MSG_TYPE_CUSTOM) {
            ...
            if (null != mOnCustomMessageDrawListener) {
    ...
    public List<MessageInfo> getDataSouurce() {
        return mDataSource;
