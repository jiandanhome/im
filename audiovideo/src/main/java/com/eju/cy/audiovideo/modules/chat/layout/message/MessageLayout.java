...
import com.eju.cy.audiovideo.component.PopupList;
...
//            LogUtils.w("消息时间"+time+"\n"+msg.getMsgTime());
//           LogUtils.w("时间差"+TimeUtils.getTimeSpan(time,msg.getMsgTime(), TimeConstants.MSEC));

           if (TimeUtils.getTimeSpan(time,msg.getMsgTime(), TimeConstants.MSEC)<120){
               action = new PopMenuAction();
        ...
        mAdapter.setOnItemClickListener(new MessageLayout.OnItemClickListener() {
            ...
            public void onMessageLongClick(View view, int position, MessageInfo messageInfo) {
                if (mOnItemClickListener != null) {
                    ...
                    LogUtils.w("设置消息长按监听成功");
                }else {
                    LogUtils.w("设置消息长按监听失败");
                }
            }
