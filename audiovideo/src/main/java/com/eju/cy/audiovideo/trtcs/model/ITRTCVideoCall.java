...
public interface ITRTCVideoCall {
     ...
     * @param jurisdictionList 有权限开视频用户列表
     */
    void groupCall(List<String> userIdList, List<String> jurisdictionList, int type, String groupId);
     ...
     * @param userID
     */
    void removeInvited(String userID);
}
