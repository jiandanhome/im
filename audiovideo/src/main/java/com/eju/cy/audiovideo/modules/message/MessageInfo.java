...
public class MessageInfo {
     ...
     * 上传文件
     */
    public static final int MSG_TYPE_GROUP_UPLOAD_FILE = 0x108;
    ...
    private String operationId; //操作方ID  如 刘德华转让群主给周润发中的  刘德华
    private String acceptId;//被操作方ID  如 刘德华转让群主给周润发中的  周润发

    private boolean grade;//是否显示黄V


    private  boolean isDelete;//是否删除---智能小区卡片
