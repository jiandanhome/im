...
import com.eju.cy.audiovideo.component.CustomLinearLayoutManager;
import com.eju.cy.audiovideo.component.indexlib.IndexBar.widget.IndexBar;
import com.eju.cy.audiovideo.component.indexlib.suspension.SuspensionDecoration;
...
import com.eju.cy.audiovideo.utils.ThreadHelper;
        ...
        BackgroundTasks.getInstance().runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (timFriends.size() == 0) {
                    //获取联系人列表
                    EjuImController.getInstance().getFriendList(new ImCallBack() {
                        @Override
                        ...
                        public void onSuccess(Object data) {
                            ...
                            List<TIMFriend> timFriends = new ArrayList<>();


                            if (null != data) {
                                timFriends.addAll((Collection) data);
                            }
